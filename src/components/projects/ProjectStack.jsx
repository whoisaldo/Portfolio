        ...
        {projects.map((p, i) => (
          ...
          >
            <div className="flex items-center gap-3 mb-4">
              ...
              {p.status === "live" && <span className="mono-label text-ember">live</span>}
            </div>
            ...
            <p className="mono-label text-dim mb-4">{p.tagline}</p>
            <p className="font-serif text-muted leading-[1.6] mb-6 max-w-[54ch]">
              {p.description}
            </p>
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                type="button"
                onClick={() => onOpen(i)}
                className="inline-flex items-center gap-2.5 px-5 py-2.5 mono-label font-bold text-ink"
                style={{ backgroundColor: "rgb(var(--accent))" }}
              >
                Open
